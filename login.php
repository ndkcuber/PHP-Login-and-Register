 ...
 <body>
    <div class="container">
         <div class="container card mt-4" data-bs-theme="dark">
            <h1 class="mt-4 mx-4 text-center">Đăng nhập</h1>
            <form class="m-5" id="user-login" data-bs-theme="dark" onsubmit="">
              <div class="mb-3">
              ...
              <div class="mb-3 form-check">
                <button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#loginuser">Đăng nhập</button>
              </div>
            </form> 
        </div>   
    </div>
    <script>
      ...
      form.addEventListener('submit', function(event) {
        ...
        xhr.open('POST', './utils/log.php'); // set endpoint
